...
st.set_page_config(page_title="Bank Data ML App", layout="wide")
st.title("Bank Marketing Classification App")


st.markdown("### Download Sample Test Dataset")
st.markdown(
    "[Click here to download test data](https://raw.githubusercontent.com/debarun-bits/bank-data-app-2024DC04041/main/data/bank.csv)"
)
st.markdown("---")


models = joblib.load("model/saved_models_2024DC04041.pkl")
...
if uploaded_file is not None:
    ...
    try:
        ...
        if hasattr(model, "decision_function"):
            ...
            st.error("Model does not support probability output.")
            st.stop()
    ...
    col2.metric("Precision", round(precision_score(y_true, y_pred, zero_division=0), 3))
